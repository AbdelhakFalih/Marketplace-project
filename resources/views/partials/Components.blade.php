        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-white active" aria-current="page" href="{{ url('/') }}" data-i18n="home">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/products') }}" data-i18n="products">Produits</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/about') }}" data-i18n="about">À propos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/contact') }}" data-i18n="contact">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/cooperatives') }}" data-i18n="cooperatives">Coopératives</a>
                    </li>
                </ul>
                <div class="d-flex align-items-center">
                    <a href="{{ url('/login') }}" class="btn btn-outline-light mx-2" data-i18n="login">Connexion</a>
                    <a href="{{ url('/register') }}" class="btn btn-outline-light mx-2" data-i18n="register">Inscription</a>
...
@elseif($compo == "Menu User-space")
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <a class="navbar-brand text-white fw-bold" href="{{ url('/user-space') }}" data-i18n="userDashboard">Tableau de bord</a>
            <div class="collapse navbar-collapse" id="navbarUserSpace">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/user-space/profile') }}" data-i18n="profile">Profil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/user-space/offers') }}" data-i18n="offers">Mes Offres</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/user-space/notifications') }}" data-i18n="notifications">Notifications</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ url('/logout') }}" data-i18n="logout">Déconnexion</a>
                    </li>
                </ul>
                <div class="d-flex align-items-center">
                    <button id="lang-fr" title="Français" class="btn p-0 mx-2 lang-btn" onclick="changeLanguage('fr')">
...
@elseif($compo == "Footer")
    <footer class="bg-light text-center py-4">
        ...
        <div class="mt-2">
            <a href="{{ url('/terms') }}" class="text-dark mx-2" data-i18n="terms">Conditions d'utilisation</a>
            <a href="{{ url('/privacy') }}" class="text-dark mx-2" data-i18n="privacy">Politique de confidentialité</a>
        </div>
    </footer>
@elseif($compo == "Errors_Page")
    <div class="container mt-5 text-center">
        ...
        <a href="{{ url('/') }}" class="btn btn-primary mt-3" data-i18n="backHome">Retour à l'accueil</a>
    </div>
@endif
