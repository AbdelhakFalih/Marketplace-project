        ...
        @if(isset($action) && $action == 'register')
            ...
            <form action="/sinscrire" method="post" class="form-login">
                ...
                <select id="role" name="role" required>
                    <option value="" disabled {{ old('role') ? '' : 'selected' }} data-i18n="selectRole">Choisissez
                        votre rôle
                    </option>
                    <option value="cooperative"
                            {{ old('role') == 'cooperative' ? 'selected' : '' }} data-i18n="cooperative">Coopérative
                    </option>
                    <option value="commerçant" {{ old('role') == 'commerçant' ? 'selected' : '' }} data-i18n="merchant">
                        Commerçant
                    </option>
                </select>
