...
<head>
    ...
    <title data-i18n="title">Marketplace Coopératives - Accueil</title>
</head>
<body>
...
<main class="container my-5">
    <section class="intro text-center">
        ...
        <p class="mb-4" data-i18n="register">Publiez vos produits, trouvez des partenaires et développez votre activité grâce à une interface simple et rapide.</p>
        <a href="<?php echo e(url('/register')); ?>" class="btn btn-success" data-i18n="signUpBtn">Rejoindre maintenant</a>
    </section>
    <section class="mt-5">
        ...
        <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('images/product1.jpg')); ?>" class="d-block w-100" alt="Produit 1">
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/product2.jpg')); ?>" class="d-block w-100" alt="Produit 2">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/product3.jpg')); ?>" class="d-block w-100" alt="Produit 3">
                    <div class="carousel-caption d-none d-md-block">
...
<?php /**PATH C:\Users\hp\Application-Marketplace\resources\views/Home.blade.php ENDPATH**/ ?>