...
Route::get('/validate', [RegisterController::class, 'showValidate'])->name('showValidate');
Route::post('/validate/confirm', [RegisterController::class, 'confirmValidate'])->name('confirmValidate');
